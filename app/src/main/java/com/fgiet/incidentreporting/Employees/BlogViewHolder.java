...
/**
 * Created by 1401480 on 7/15/2017.
 */
...
public class BlogViewHolder extends RecyclerView.ViewHolder {
    ...
    public void setName(String name) {
        TextView post_name = (TextView) mView.findViewById(R.id.tv_emptab1_name);
        post_name.setText(name);
    }

    public void setEmailid(String emailid){
        TextView email_id=(TextView) mView.findViewById(R.id.tv_emptab1_email);
        email_id.setText(emailid);
    }
    public void setUserid(String userid){
        TextView user_id=(TextView) mView.findViewById(R.id.tv_emptab1_type);

        if(userid.equals("")){
            user_id.setTextColor(Color.parseColor("#FF0000"));
            user_id.setText("Anonymous");
        }
        else{
            user_id.setTextColor(Color.parseColor("#00FF00"));
            user_id.setText("Authorised");
        }
    ...
    public void setDate(String date1) {
        ...
        try{
            ...
            TextView date=(TextView) mView.findViewById(R.id.tv_emptab1_time);
    ...
    public void setPosition(int position){
        TextView serial_no=(TextView)mView.findViewById(R.id.tv_emptab1_serialno);
